...
public class PoolDownDialogProducerStation extends Stage {
    ...
    public class PoolDownList extends ListView{
        ...
        public PoolDownList(Stage myStage, TextField txtField, List<ProducerStation> listProducerStations) {
            super();
            ...
            setPrefHeight(120);
            fillObservableList(listProducerStations);
            initListView();
            addListener();
            this.requestFocus();
        ...
        private void fillObservableList(List<ProducerStation> listProducerStations ) {
            for(int i=0;(i<=listProducerStations.size()-1);i++) {

                        items.add(listProducerStations.get(i).getStationName()+ " ," + listProducerStations.get(i).getStationCity());
    ...
    public PoolDownDialogProducerStation(Stage parentStage, TextField textField, List<ProducerStation> listProducerStations) {
        ...
        VBox root = new VBox();
        PoolDownList poolDownList = new PoolDownList(this,textField,listProducerStations);
